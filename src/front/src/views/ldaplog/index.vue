<template>
    <div class="app-container">
        ...
        <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
            ...
            <el-table-column label="Path" width="500px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.pathname }}</span>
                </template>
            </el-table-column>
            <el-table-column label="IP from" width="500px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.ip_from }}</span>
                </template>
            </el-table-column>
            <el-table-column label="Record Time" width="420px" align="center">
                <template slot-scope="{row}">
...
<script>
import { fetchListLdaplog, fetchPv, createArticle, updateArticle } from '@/api/article'
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            fetchListLdaplog(this.listQuery).then(response => {
