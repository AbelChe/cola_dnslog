<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Path" width="250px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.path }}</span>
        </template>
      </el-table-column>
      <el-table-column label="IP From" width="150px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="Header" width="400px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.headers }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Body Length" width="130px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.content_length }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Body Data" width="600px" align="center">
        <template slot-scope="{row}">
...
<script>
import { fetchListHttplog, fetchPv, createArticle, updateArticle, deleteHttplog, deleteHttplog_all } from '@/api/logdata'
