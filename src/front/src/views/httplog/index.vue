<template>
    <div class="app-container">
        ...
        <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
            style="width: 100%;" @sort-change="sortChange" :row-style="iRowStyle" :cell-style="iCellStyle"
            ...
            <el-table-column label="Path" width="300px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.path }}</span>
                </template>
            </el-table-column>
            <el-table-column label="IP From" width="200px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.ip_from }}</span>
                </template>
            </el-table-column>
            <el-table-column label="User Agent" width="300px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.useragent }}</span>
                </template>
            </el-table-column>
            <el-table-column label="Record Time" width="200px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.record_time }}</span>
                </template>
            </el-table-column>
            <el-table-column label="Header" width="300px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.headers }}</span>
                </template>
            </el-table-column>
            <el-table-column label="Body Length" width="100px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.content_length }}</span>
                </template>
            </el-table-column>
            <el-table-column label="Body Data" width="300px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.body_data }}</span>
                </template>
            </el-table-column>
        </el-table>
...
<script>
import { fetchListHttplog, fetchPv, createArticle, updateArticle } from '@/api/article'
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            fetchListHttplog(this.listQuery).then(response => {
