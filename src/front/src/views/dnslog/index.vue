<template>
    <div class="app-container">
        ...
        <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
            ...
            <el-table-column label="Record" width="500px" align="center">
                <template slot-scope="{row}">
...
<script>
import { fetchListDnslog, fetchPv, createArticle, updateArticle } from '@/api/article'
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            fetchListDnslog(this.listQuery).then(response => {
