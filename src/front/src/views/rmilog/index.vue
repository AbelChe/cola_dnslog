<template>
    <div class="app-container">
        ...
        <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
            ...
            <el-table-column label="Path" width="330px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.objectname }}</span>
                </template>
            </el-table-column>
            <el-table-column label="RMI Client IP" width="400px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.rmi_client_ip }}</span>
                </template>
            </el-table-column>
            <el-table-column label="IP from" width="400px" align="center">
                <template slot-scope="{row}">
...
<script>
import { fetchListRmilog, fetchPv, createArticle, updateArticle } from '@/api/article'
