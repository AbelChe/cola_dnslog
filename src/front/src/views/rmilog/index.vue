<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="RMI Client IP" width="300px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.rmi_client_ip }}</span>
        </template>
      </el-table-column>
      <el-table-column label="IP from" width="300px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.ip_from }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Record Time" width="300px" align="center">
        <template slot-scope="{row}">
...
<script>
import { fetchListRmilog, fetchPv, createArticle, updateArticle, deleteRmilog, deleteRmilog_all } from '@/api/logdata'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      fetchListRmilog(this.listQuery).then(response => {
